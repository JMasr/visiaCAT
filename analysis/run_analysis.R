...
devtools::load_all(here::here()) # Loads all functions from the R/ directory
...
#   patient_data = data_with_anchor_theta,
#   item_bank_cols = final_bank_i_cols,
...
#   }
#
#   # Save the full DIF report
#   write_csv(
#     as.data.frame(dif_report),
#     file.path(RESULTS_DIR, "report_dif_analysis.csv")
#   )
# }
